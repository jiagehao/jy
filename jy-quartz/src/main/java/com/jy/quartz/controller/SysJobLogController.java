package com.jy.quartz.controller;
...
public class SysJobLogController extends BaseController
{
    ...
    public String detail(@PathVariable("jobLogId") Long jobLogId, ModelMap map)
    {
        map.put("name", "jobLog");
        map.put("jobLog", jobLogService.selectJobLogById(jobLogId));
