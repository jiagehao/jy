...
public class SysRoleController extends BaseController
{
    ...
    public String authDataScope(@PathVariable("roleId") Long roleId, ModelMap map)
    {
        map.put("role", roleService.selectRoleById(roleId));
    ...
    public String authUser(@PathVariable("roleId") Long roleId, ModelMap map)
    {
        map.put("role", roleService.selectRoleById(roleId));
    ...
    public String selectUser(@PathVariable("roleId") Long roleId, ModelMap map)
    {
        map.put("role", roleService.selectRoleById(roleId));
